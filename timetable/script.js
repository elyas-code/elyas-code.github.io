const timetables = {
    0: { // 11.CCP
        ...
        4: [
            { subject: "PHY201", teacher: "FM", room: "BB1", start: "07:15", end: "08:20" },
            { subject: "PE", teacher: "O", room: "PE", start: "08:20", end: "09:00" },
            { subject: "Break", teacher: "N/A", room: "N/A", start: "09:00", end: "09:15" },
            ...
            { subject: "Break", teacher: "N/A", room: "N/A", start: "11:55", end: "12:10" },
            { subject: "ENG201", teacher: "JP", room: "A2", start: "12:10", end: "12:50" },
            { subject: "Club", teacher: "N/A", room: "N/A", start: "12:55", end: "13:45" },
        ]
    },
    1: { // 11.AI
        0: [ // Sunday
        ...
        4: [
            ...
            { subject: "Break", teacher: "N/A", room: "N/A", start: "11:55", end: "12:10" },
            { subject: "WEB201", teacher: "AK", room: "C2", start: "12:10", end: "12:50" },
            { subject: "Club", teacher: "N/A", room: "N/A", start: "12:55", end: "13:45" },
        ]
    },
    2: { // 11.SEC
